...
@section('content')
                    ...
                    <div class="card-content">
                        <div class="card-body card-dashboard">
                            <div style="    margin-bottom: 10px; text-align: end;">
                                <button style="" class="btn btn-primary"  data-toggle="modal" data-target="#exampleModal">Add Express Point</button>
                            </div>

                            <div style="    margin-bottom: 10px; text-align: end;">
                                <button style="" class="btn btn-primary"  data-toggle="modal" data-target="#exampleModal2">Add Priority Point</button>
                            </div>
      ...
      <tbody>
        ...
        @foreach ($user as $users)
            ...
            <tr role="row" class="odd">
                ...
                <td class="sorting_1">{{ $users->points }}</td>
                <td class="sorting_1">{{ $users->type }}</td>
                ...
                <td class="sorting_1">
                    ...
                    <div class="dropdown-menu" x-placement="bottom-start"
                        ...
                        <a class="btn"
                            href="{{ url('delete_express', $users->id) }}" >Delete</a>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Add Priority Point</h5>

              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <form action="{{url('admin/priority_point')}}">
                @csrf
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Add Express Point</h5>

              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <form action="{{url('admin/express_point')}}">
            <div class="modal-body">
