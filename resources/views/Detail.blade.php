        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                ...
                <form action="{{ route('product_status', [$product->id]) }}">
                    ...
                    <?php
                    $str_arr = explode(',', $product->photos);

                    ?>
                    <div class="row">
                        <div class="col-lg-6 mb-5">
                            <img src="{{ asset('/uploads/' . $str_arr[0]) }}"
                                style=" border-radius: 25px;min-width: 77%;  width: 77%;" alt="">
                        </div>
                            ...
                            <div class="mb-3">
                                ...
                                <p class="mb-0"><a href="#">{{ $product->Brand->brand_name }}
                                        ...
                                        <select name="statuss" id="" class="form-control">
                                            ...
                                            <option value="1" @if ($product->status_expert == '1')  selected @endif style="background: black"> Approve
                                            </option>
                                            <option value="0" @if ($product->status_expert == '0')  selected  @endif style="background: black">Turn Down
                                            </option>
                                        </select>
                                ...
                                <textarea name="Comment" id="" value="{{ $product->comment }}" class="form-control"
                                    cols="10" rows="3">{{ $product->comment }}</textarea>
