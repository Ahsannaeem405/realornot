                    ...
                    <ul class="site-menu js-clone-nav mx-auto d-none d-lg-block">
                        ...
                        @if (Auth::check())
                            ...
                            @if (Auth::user()->role == 'expert')
                                ...
                                <div class="dropdown">
                                    <li class="dropdown-toggle" id="dropdownMenuButton" data-toggle="dropdown"
                                ...
                                @foreach ($express as $expresss)
                                    <?php
                                    $expert_point += $expresss->expert_point;
                                    ?>
...
<div class="modal fade" id="Authentication" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel" style="text-align: center;font-size: 24px;">Register
                </h5>
            ...
            <div class="modal-body" style="text-align: center">
                <form action=""></form>
                <a href="{{ url('buyer') }}" type="button" class="btn btn-primary">Buyer</a>
                <p></p>
                <a href="{{ url('seller') }}" type="button" class="btn btn-danger">Seller</a>
                <p></p>
                <a href="" type="button" data-toggle="modal" data-target="#expert_signup" class="btn btn-secondary"
                    data-dismiss="modal">Expert</a>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                {{-- <button type="button" class="btn btn-primary">Save changes</button> --}}
...
<div class="modal fade" id="expert_signup" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
