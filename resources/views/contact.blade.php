            ...
            <form action="#">
              ...
              <div class="row form-group">
                ...
                <div class="col-md-12">
                  ...
                  <input type="subject" id="subject" placeholder="Subject"  class="form-control">
                </div>
              </div>
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  ...
                  <textarea name="message" id="message" cols="30" rows="7" placeholder="Message" class="form-control" placeholder="Write your notes or questions here..."></textarea>
                </div>
              </div>
