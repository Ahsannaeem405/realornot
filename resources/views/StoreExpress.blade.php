      ...
      <div class="container">
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-md-7">
            <div class="row mb-5">
              <div class="col-12 ">
                <h2 class="site-section-heading text-center">Seller/Store in paying</h2>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-12 mb-5">
            ...
            <div style="    background: black;color: red;" class="alert alert-success">
                ...
                <form method="POST"action="{{route('Store_Seller')}}" enctype="multipart/form-data" >
                    @csrf
              ...
              <div class="row form-group">
                ...
                <div class="col-md-12">
                  <label class="text-white" for="subject">Store Number</label>
                  <input id="Store" type="text" class="form-control" name="Store" required >
